...
const Testimonials = () => {
    return (
        <div>
            <div className="rounded-xl bg-cyan-500 shadow-xl h-20 z-0">
            ...
            <div className='text-center bg-slate-700 rounded-xl p-6 mb-12 shadow-2xl'>
                ...
                <ul width={'w-96'} className='text-white text-left p-3 '>
                    ...
                    <li className='text-xl font-extrabold text-decoration-line: underline text-blue-300 flex'><CheckBadgeIcon className='flex w-7 text-green-500 mr-1' />Hassle-Free Management:</li>
            ...
            <div className="grid gap-6 text-center md:grid-cols-3 lg:gap-12 mt-6">
                <div className="mb-1 md:mb-0">
                    ...
                    <svg
                        ...
                        fill="currentColor"
                        className="inline-block h-5 w-5 sm:h-7 sm:w-7 pr-1"
                        viewBox="0 0 24 24">
                        <path
                        d="M13 14.725c0-5.141 3.892-10.519 10-11.725l.984 2.126c-2.215.835-4.163 3.742-4.38 5.746 2.491.392 4.396 2.547 4.396 5.149 0 3.182-2.584 4.979-5.199 4.979-3.015 0-5.801-2.305-5.801-6.275zm-13 0c0-5.141 3.892-10.519 10-11.725l.984 2.126c-2.215.835-4.163 3.742-4.38 5.746 2.491.392 4.396 2.547 4.396 5.149 0 3.182-2.584 4.979-5.199 4.979-3.015 0-5.801-2.305-5.801-6.275z" />
                    </svg>
                    We just started our store and so far everything has been great. I couldn't be happier with the support and service they provide.
                    <svg className="inline-block h-5 w-5 sm:h-7 sm:w-7 pl-1" clipRule="evenodd" fillRule="evenodd" strokeLinejoin="round" strokeMiterlimit="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="m2.699 20c-.411 0-.699-.312-.699-.662 0-.249.145-.516.497-.703 1.788-.947 3.858-4.226 3.858-6.248-3.016.092-4.326-2.582-4.326-4.258 0-2.006 1.738-4.129 4.308-4.129 3.241 0 4.83 2.547 4.83 5.307 0 5.981-6.834 10.693-8.468 10.693zm10.833 0c-.41 0-.699-.312-.699-.662 0-.249.145-.516.497-.703 1.788-.947 3.858-4.226 3.858-6.248-3.015.092-4.326-2.582-4.326-4.258 0-2.006 1.739-4.129 4.308-4.129 3.241 0 4.83 2.547 4.83 5.307 0 5.981-6.833 10.693-8.468 10.693z" fillRule="nonzero"/></svg>
                    </p>
                ...
                <div className="mb-12 md:mb-0">
                    ...
                    <p className="mb-4 text-lg">
                        ...
                        Inclined to diversify my portfolio, which led me to this unique opportunity in the e-commerce sector. I will recommend others. $70,000 In Profits.
                        <svg className="inline-block h-5 w-5 sm:h-7 sm:w-7 pl-1" clipRule="evenodd" fillRule="evenodd" strokeLinejoin="round" strokeMiterlimit="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="m2.699 20c-.411 0-.699-.312-.699-.662 0-.249.145-.516.497-.703 1.788-.947 3.858-4.226 3.858-6.248-3.016.092-4.326-2.582-4.326-4.258 0-2.006 1.738-4.129 4.308-4.129 3.241 0 4.83 2.547 4.83 5.307 0 5.981-6.834 10.693-8.468 10.693zm10.833 0c-.41 0-.699-.312-.699-.662 0-.249.145-.516.497-.703 1.788-.947 3.858-4.226 3.858-6.248-3.015.092-4.326-2.582-4.326-4.258 0-2.006 1.739-4.129 4.308-4.129 3.241 0 4.83 2.547 4.83 5.307 0 5.981-6.833 10.693-8.468 10.693z" fillRule="nonzero"/></svg>
                    </p>
                ...
                <div className="mb-12 md:mb-0">
                    ...
                    As a naturally skeptical person, it took me a year of diligent research before I finally decided to take the plunge and start my own e-commerce business. That's when I stumbled upon these guys, and I have to say, they delivered on their promises in every way.
                    <svg className="inline-block h-5 w-5 sm:h-7 sm:w-7 pl-1" clipRule="evenodd" fillRule="evenodd" strokeLinejoin="round" strokeMiterlimit="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="m2.699 20c-.411 0-.699-.312-.699-.662 0-.249.145-.516.497-.703 1.788-.947 3.858-4.226 3.858-6.248-3.016.092-4.326-2.582-4.326-4.258 0-2.006 1.738-4.129 4.308-4.129 3.241 0 4.83 2.547 4.83 5.307 0 5.981-6.834 10.693-8.468 10.693zm10.833 0c-.41 0-.699-.312-.699-.662 0-.249.145-.516.497-.703 1.788-.947 3.858-4.226 3.858-6.248-3.015.092-4.326-2.582-4.326-4.258 0-2.006 1.739-4.129 4.308-4.129 3.241 0 4.83 2.547 4.83 5.307 0 5.981-6.833 10.693-8.468 10.693z" fillRule="nonzero"/></svg>
                    </p>
                </div>
            </div>
