...
export default function PerfectFit({formStep, nextFormStep, increase}) {
    ...
    return (
        <div className={formStep === 3 ? 'p-10': 'hidden'}>
            ...
            <div className='text-2xl' style={{color: '#E3E3E3'}}> These funds are deployed to build your store, get it approved by Amazon to sell premium household named brands (Phillips, Vizio, Keurig, etc), and fund your first round of inventory.</div>
            <div className='text-3xl text-gray-50 pb-5' style={{color: 'yellow'}}>Do you have the required $35,000 upfront cost?</div>
